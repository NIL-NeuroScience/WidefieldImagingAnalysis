...
%% Standard settings 
stdSettings.mp = 0;        % run with parallel processing
stdSettings.cores= 8;      % number of CPU cores
stdSettings.doNorm = 0;    % optional: run normalization
stdSettings.nChannels = 4; % optional: number of channels per cycle
stdSettings.nImport=1;   %number of images to import (0=all, per channel)
stdSettings.doCat=0;       % optional: create image montage
